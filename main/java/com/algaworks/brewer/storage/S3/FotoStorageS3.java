...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "jmbrewer";
	...
	public String getUrl(String foto) {
		if (!StringUtils.isEmpty(foto)) {
			return "https://s3.eu-west-3.amazonaws.com/"+BUCKET+"/" + foto;
		}
	...
	private ObjectMetadata enviarFoto(String novoNome, MultipartFile arquivo, AccessControlList acl)
		...
		metadata.setContentLength(arquivo.getSize()); // avoid the server to have to calculate this value
	...
	private void enviarThumbnail(String novoNome, MultipartFile arquivo, AccessControlList acl)	throws IOException {
		...
		amazonS3.putObject(new PutObjectRequest(BUCKET, FotoStorage.THUMBNAIL_PREFIX + novoNome, is, thumbMetadata)
					.withAccessControlList(acl));
	}
